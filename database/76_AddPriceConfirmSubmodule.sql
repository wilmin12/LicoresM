-- ============================================================
-- Script  : 76_AddPriceConfirmSubmodule.sql
-- Database: LicoresMaduoDB
-- Purpose : Register COST_PRICE_CONFIRM submodule and set
--           permissions (Admin/SuperAdmin full, User no access).
...
USING (VALUES
    (@CostId, 'Price Confirmation', 'COST_PRICE_CONFIRM', NULL, 10)
...
DECLARE @SmId INT = (SELECT SubmoduleId FROM dbo.LM_Submodules WHERE SubmoduleCode = 'COST_PRICE_CONFIRM');
...
PRINT 'COST_PRICE_CONFIRM submodule and permissions registered.';
GO
